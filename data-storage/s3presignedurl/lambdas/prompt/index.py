...
def handler(event, context):
    ...
    try:
        try:
            ...
            result = ""
            text = ""
            input_tokens = "No tokens"
            output_tokens = "No tokens"
            created = ""
            #We are actually going to make a call to Bedrock 
            # Example request body for Claude
    ...
    "messages": [
      {
        ...
        row_data["exceptionOccured"] = exceptionOccured
