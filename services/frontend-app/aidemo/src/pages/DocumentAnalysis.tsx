  ...
  const handleSelectChange = (index: number) => {
   ...
   // console.log("after selected option="+JSON.stringify(selectedDropdownOption))
    ...
    return (
        ...
        <p className="font-bold">Upload a PDF to the Gallery. Textract will extract the text to the textract S3 folder. Then will be available for Document Analysis here.</p>
